...
<div class="col-md-3 static">
  ...
  <ul class="nav-news-feed">
    <li><i class="icon ion-ios-paper"></i><div><a href="/feed">Feed de notícias</a></div></li>
    <li><i class="icon ion-ios-people"></i><div><a href="/conhecidos">Pessoas que talvez conheças</a></div></li>
    <li><i class="icon ion-ios-people-outline"></i><div><a href="/feed-amigos">Amigos</a></div></li>
    <li><i class="icon ion-chatboxes"></i><div><a href="/mensagens">Mensagens</a></div></li>
            ...
            <div class="create-post">
            	<div class="row">
                  ...
                  <div class="form-group">
                    ...
                    <textarea name="texts" id="exampleTextarea" cols="30" rows="1" class="form-control" placeholder="Escreva o que sentes"></textarea>
                  </div>
                </div>
